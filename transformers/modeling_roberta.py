...
class RobertaEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        print('type_vocab,hidden_size:', config.type_vocab_size, config.hidden_size)
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        if position_ids is None:
            if input_ids is not None:
                # print('position_ids is none and input_ids is not none.')
                # Create the position ids from the input token ids. Any padded tokens remain padded.
                position_ids = create_position_ids_from_input_ids(input_ids, self.padding_idx).to(input_ids.device)
            else:
                # print('position_ids is none, and input_ids is none.')
...
def create_position_ids_from_input_ids(input_ids, padding_idx):
    ...
    # print('sizeofpositionids:',(incremental_indices.long() + padding_idx).size())
    # print('nopadding_index:',incremental_indices.long())
